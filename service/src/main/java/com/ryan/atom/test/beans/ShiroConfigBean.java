...
import com.ryan.atom.test.filter.MyFilter;
import com.ryan.atom.test.shiro.MyShiroRealm;
...
public class ShiroConfigBean {
    ...
    public ShiroFilterFactoryBean shirFilter(org.apache.shiro.mgt.SecurityManager securityManager) {
        ...
        //filterChainDefinitionMap.put("/user/permissionY", "perms[权限添加]");
        //filterChainDefinitionMap.put("/user/permissionN", "perms[权限添加2]");
